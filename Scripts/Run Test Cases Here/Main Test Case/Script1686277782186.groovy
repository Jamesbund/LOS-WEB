...
WebUI.callTestCase(findTestCase('LOS/Loan Matrix/Loan Amount/LA_DELETE'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('LOS/Reports/Audit Trail Reports/ATR Generate in PDF'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('LOS/Loan Matrix/Loan Product/LP_ADD'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('LOS/Loan Matrix/Loan Product/LP_EDIT'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('LOS/Loan Matrix/Loan Product/LP_DELETE'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('LOS/Reports/Audit Trail Reports/ATR Generate in PDF'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('LOS/Logout'), [:], FailureHandling.CONTINUE_ON_FAILURE)
